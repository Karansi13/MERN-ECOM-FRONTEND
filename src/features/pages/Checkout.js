...
const Checkout = () => {
  ...
  const handleQuantity = (e, item) => {
    // The reason we use + is that thw value is coming in the form of string & we are converting it in int.
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form
              className="bg-white px-5 py-12 mt-14"
              noValidate
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        type="tel" // mobile me numpad open hojaega
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto bg-white mt-14 max-w-7xl px-4 sm:px-3 lg:px-3">
              <div className="border-t border-gray-200 px-4 py-6 sm:px-3">
                <h2 className="text-4xl my-5 font-bold tracking-tighter text-gray-800">
                  Cart
                </h2>
